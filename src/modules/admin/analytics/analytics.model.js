  ...
  async getProductBestSeller() {
    const sql = `
        SELECT
            ...
            -- Total quantity sold today, excluding cancelled orders
            COALESCE(SUM(
                CASE WHEN o.order_status != 'CANCELLED'
                AND o.placed_at::date = CURRENT_DATE
            ...
            -- Total revenue today (quantity x unit price), excluding cancelled orders
            COALESCE(SUM(
                CASE WHEN o.order_status != 'CANCELLED'
                AND o.placed_at::date = CURRENT_DATE
            ...
            -- Revenue growth trend: today vs yesterday
            ...
            -- Top 2 regions where this product is most ordered today
            (
